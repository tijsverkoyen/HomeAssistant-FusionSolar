    ...
    for device in devices:
        ...
        if device.type_id == PARAM_DEVICE_TYPE_ID_BATTERY:
            entities_to_create = [
                ...
                {'class': 'FusionSolarRealtimeDeviceDataPowerSensor', 'attribute': 'max_charge_power',
                 'name': 'Maximum charge power'},
                {'class': 'FusionSolarRealtimeDeviceDataPowerSensor', 'attribute': 'max_discharge_power',
                 'name': 'Maximum discharge power'},
                {'class': 'FusionSolarRealtimeDeviceDataPowerSensor', 'attribute': 'ch_discharge_power',
